<?php
App::uses('AsTvshowsmatching', 'Model');

/**
 * AsTvshowsmatching Test Case
 *
 */
class AsTvshowsmatchingTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->AsTvshowsmatching = ClassRegistry::init('AsTvshowsmatching');
	}
