<?php
App::uses('ExcludetvshowsfromscanVideo', 'Model');

/**
 * ExcludetvshowsfromscanVideo Test Case
 *
 */
class ExcludetvshowsfromscanVideoTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->ExcludetvshowsfromscanVideo = ClassRegistry::init('ExcludetvshowsfromscanVideo');
	}
 ...
 */
	public function tearDown() {
		unset($this->ExcludetvshowsfromscanVideo);
