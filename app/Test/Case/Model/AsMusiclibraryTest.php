<?php
App::uses('AsMusiclibrary', 'Model');

/**
 * AsMusiclibrary Test Case
 *
 */
class AsMusiclibraryTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->AsMusiclibrary = ClassRegistry::init('AsMusiclibrary');
	}
