<?php
App::uses('AsVideolibrary', 'Model');

/**
 * AsVideolibrary Test Case
 *
 */
class AsVideolibraryTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->AsVideolibrary = ClassRegistry::init('AsVideolibrary');
	}
