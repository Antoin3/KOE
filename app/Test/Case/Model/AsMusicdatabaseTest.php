<?php
App::uses('AsMusicdatabase', 'Model');

/**
 * AsMusicdatabase Test Case
 *
 */
class AsMusicdatabaseTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->AsMusicdatabase = ClassRegistry::init('AsMusicdatabase');
	}
