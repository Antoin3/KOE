<?php
App::uses('ExcludefromlistingAudio', 'Model');

/**
 * ExcludefromlistingAudio Test Case
 *
 */
class ExcludefromlistingAudioTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->ExcludefromlistingAudio = ClassRegistry::init('ExcludefromlistingAudio');
	}
 ...
 */
	public function tearDown() {
		unset($this->ExcludefromlistingAudio);
