<?php
App::uses('AsVideoscanner', 'Model');

/**
 * AsVideoscanner Test Case
 *
 */
class AsVideoscannerTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->AsVideoscanner = ClassRegistry::init('AsVideoscanner');
	}
