<?php
App::uses('ExcludefromscanAudio', 'Model');

/**
 * ExcludefromscanAudio Test Case
 *
 */
class ExcludefromscanAudioTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->ExcludefromscanAudio = ClassRegistry::init('ExcludefromscanAudio');
	}
 ...
 */
	public function tearDown() {
		unset($this->ExcludefromscanAudio);
