<?php
App::uses('Trailermatching', 'Model');

/**
 * Trailermatching Test Case
 *
 */
class TrailermatchingTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Trailermatching = ClassRegistry::init('Trailermatching');
	}
