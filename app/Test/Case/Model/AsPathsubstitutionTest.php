<?php
App::uses('AsPathsubstitution', 'Model');

/**
 * AsPathsubstitution Test Case
 *
 */
class AsPathsubstitutionTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->AsPathsubstitution = ClassRegistry::init('AsPathsubstitution');
	}
