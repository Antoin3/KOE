<?php
App::uses('AsMoviestaking', 'Model');

/**
 * AsMoviestaking Test Case
 *
 */
class AsMoviestakingTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->AsMoviestaking = ClassRegistry::init('AsMoviestaking');
	}
