<?php
App::uses('AsSlideshow', 'Model');

/**
 * AsSlideshow Test Case
 *
 */
class AsSlideshowTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->AsSlideshow = ClassRegistry::init('AsSlideshow');
	}
