<?php
App::uses('AsVideodatabase', 'Model');

/**
 * AsVideodatabase Test Case
 *
 */
class AsVideodatabaseTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->AsVideodatabase = ClassRegistry::init('AsVideodatabase');
	}
