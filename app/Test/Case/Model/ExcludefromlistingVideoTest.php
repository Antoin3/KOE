<?php
App::uses('ExcludefromlistingVideo', 'Model');

/**
 * ExcludefromlistingVideo Test Case
 *
 */
class ExcludefromlistingVideoTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->ExcludefromlistingVideo = ClassRegistry::init('ExcludefromlistingVideo');
	}
 ...
 */
	public function tearDown() {
		unset($this->ExcludefromlistingVideo);
